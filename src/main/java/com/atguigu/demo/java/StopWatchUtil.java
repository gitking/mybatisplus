...
public class StopWatchUtil {
    ...
    public static void print(String controllerName, String methodName, boolean bool) {
        ...
        if (log.isTraceEnabled()) {
            log.trace("##### watch key: {}, step:{}, pretty:{}", controllerName, methodName, stopWatch.prettyPrint());
        }

        log.info("##### watch key: {}, step:{}, pretty:{}", controllerName, methodName, stopWatch.prettyPrint());
